...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"车型","运输单","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(declare.getIdentify().equals("admin")) {
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, CarModelListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
						Intent intent  = new Intent(MoreActivity.this, YunshuListActivity.class);
						startActivity(intent);
					}
					...
					if(arg2 == 0){
						...
						bundle.putString("jiahao", declare.getUserName());
